// AHMAD & CO. — WhatsApp Floating Button
// ============================================================
...
(function () {
  ...
  function createWhatsAppButton() {
    ...
    float.id = 'whatsapp-float';
    float.setAttribute('aria-label', 'Chat on WhatsApp');

    float.innerHTML = `
      <span class="whatsapp-float__label">Chat with us on WhatsApp</span>
      <a
        ...
        aria-label="Contact AHMAD & CO. on WhatsApp"
        title="Chat with us on WhatsApp"
      >
        <div class="whatsapp-float__pulse"></div>
    ...
    // Update link dynamically as message can change
    const btn = float.querySelector('#whatsapp-btn');
    btn.addEventListener('click', () => {
      btn.href = `https://wa.me/${WHATSAPP_NUMBER}?text=${getWhatsAppMessage()}`;
    });
  }
